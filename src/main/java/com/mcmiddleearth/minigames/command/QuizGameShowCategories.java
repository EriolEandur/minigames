...
public class QuizGameShowCategories extends AbstractGameCommand{
    ...
    protected void execute(CommandSender cs, String... args) {
        ...
        for(String line: PluginData.getQuestionCategories()) {
            categories.add(new FancyMessage(MessageType.WHITE)
                                        .addSimple(""+MessageUtil.STRESSED+line.charAt(0)
        ...
        MessageUtil.sendFancyListMessage((Player)cs, header, categories, "/game showcategories", page);
    }
}
